...
const completedProjects = [
  { src: storage + "/manus-storage/IMG-20260905-WA0000_e81ca732.jpg", label: "Projecto realizado 01" },
  { src: storage + "/manus-storage/IMG-20260905-WA0001(1)_02dc0cc8.jpg", label: "Projecto realizado 02" },
  { src: storage + "/manus-storage/IMG-20260905-WA0004_95f41b47.jpg", label: "Projecto realizado 03" },
  { src: storage + "/manus-storage/IMG-20260905-WA0006(1)_9c0aff63.jpg", label: "Projecto realizado 04" },
  { src: storage + "/manus-storage/IMG-20260905-WA0008_57689332.jpg", label: "Projecto realizado 05" },
  { src: storage + "/manus-storage/IMG-20260905-WA0009(1)_0788cf27.jpg", label: "Projecto realizado 06" },
  { src: storage + "/manus-storage/IMG-20260905-WA0010_96db0ba8.jpg", label: "Projecto realizado 07" },
  { src: storage + "/manus-storage/IMG-20260905-WA0013_66bbd060.jpg", label: "Projecto realizado 08" },
  { src: storage + "/manus-storage/IMG-20260905-WA0014_304fc95a.jpg", label: "Projecto realizado 09" },
  { src: storage + "/manus-storage/IMG-20260905-WA0015_5364f4e6.jpg", label: "Projecto realizado 10" },
  { src: storage + "/manus-storage/IMG-20260905-WA0016_24e95788.jpg", label: "Projecto realizado 11" },
  { src: storage + "/manus-storage/IMG-20260905-WA0019_9b7ea994.jpg", label: "Projecto realizado 12" },
  { src: storage + "/manus-storage/IMG-20260905-WA0021_98b5acd6.jpg", label: "Projecto realizado 13" },
  { src: storage + "/manus-storage/IMG-20260905-WA0022_c8dda490.jpg", label: "Projecto realizado 14" },
  { src: storage + "/manus-storage/IMG-20260905-WA0023(1)_c00026b1.jpg", label: "Projecto realizado 15" },
  { src: storage + "/manus-storage/IMG-20260905-WA0024(1)_be29429b.jpg", label: "Projecto realizado 16" },
  { src: storage + "/manus-storage/IMG-20260905-WA0025_90707722.jpg", label: "Projecto realizado 17" },
  { src: storage + "/manus-storage/IMG-20260905-WA0030_72cd693f.jpg", label: "Projecto realizado 18" },
  { src: storage + "/manus-storage/IMG-20260905-WA0031(1)_a2e73302.jpg", label: "Projecto realizado 19" },
  { src: storage + "/manus-storage/IMG-20260905-WA0032_1fc0dbb6.jpg", label: "Projecto realizado 20" },
];
