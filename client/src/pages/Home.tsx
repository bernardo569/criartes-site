...
const completedProjects = [
  { src: storage + "portfolio/IMG-20260905-WA0000.webp", label: "Projecto realizado 01" },
  { src: storage + "portfolio/IMG-20260905-WA0001(1).webp", label: "Projecto realizado 02" },
  { src: storage + "portfolio/IMG-20260905-WA0004.webp", label: "Projecto realizado 03" },
  { src: storage + "portfolio/IMG-20260905-WA0006(1).webp", label: "Projecto realizado 04" },
  { src: storage + "portfolio/IMG-20260905-WA0008.webp", label: "Projecto realizado 05" },
  { src: storage + "portfolio/IMG-20260905-WA0009(1).webp", label: "Projecto realizado 06" },
  { src: storage + "portfolio/IMG-20260905-WA0010.webp", label: "Projecto realizado 07" },
  { src: storage + "portfolio/IMG-20260905-WA0013.webp", label: "Projecto realizado 08" },
  { src: storage + "portfolio/IMG-20260905-WA0014.webp", label: "Projecto realizado 09" },
  { src: storage + "portfolio/IMG-20260905-WA0015.webp", label: "Projecto realizado 10" },
  { src: storage + "portfolio/IMG-20260905-WA0016.webp", label: "Projecto realizado 11" },
  { src: storage + "portfolio/IMG-20260905-WA0021.webp", label: "Projecto realizado 13" },
  { src: storage + "portfolio/IMG-20260905-WA0022.webp", label: "Projecto realizado 14" },
  { src: storage + "portfolio/IMG-20260905-WA0023(1).webp", label: "Projecto realizado 15" },
  { src: storage + "portfolio/IMG-20260905-WA0024(1).webp", label: "Projecto realizado 16" },
  { src: storage + "portfolio/IMG-20260905-WA0025.webp", label: "Projecto realizado 17" },
  { src: storage + "portfolio/IMG-20260905-WA0030.webp", label: "Projecto realizado 18" },
  { src: storage + "portfolio/IMG-20260905-WA0031(1).webp", label: "Projecto realizado 19" },
  { src: storage + "portfolio/IMG-20260905-WA0032.webp", label: "Projecto realizado 20" },
];
...
export default function Home() {
  ...
  useEffect(() => {
    const timer = window.setTimeout(() => setPodcastNotice(false), 5 * 60 * 1000);
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f7f4ef] text-[#191919]">
      ...
      <header className="sticky top-0 z-50 border-b border-black/10 bg-[#f7f4ef]/90 backdrop-blur-xl">
        <div className="container flex h-[78px] items-center justify-between gap-6">
          <a href="#inicio" aria-label="Criartes — início" className="brand-lockup">
            <img src={storage + "criartes-logo-transparent.png"} alt="Criartes Gráfica e Editora" className="h-12 w-auto object-contain" />
          </a>
      ...
      <section id="inicio" className="hero-section">
        <img className="hero-background" src={storage + "hero-criartes.webp"} alt="Equipa da Criartes no espaço editorial" aria-hidden="true" fetchPriority="high" decoding="async" />
        <div className="hero-grid container">
          ...
          <div className="hero-art">
            ...
            <div className="hero-photo-wrap"><img src={storage + "editorial-book.jpg"} alt="Livro editado e produzido pela Criartes" loading="lazy" decoding="async" /></div>
      ...
      <section id="precos" className="price-highlight"><div className="container"><div className="price-card"><div className="price-copy"><div className="section-kicker light">Oferta em destaque</div><h2>Impressão de livros<br /><em>a partir de 4.900 Kz.</em></h2><p>Escolha o formato e o papel ideal para a sua obra. Consulte as tabelas actualizadas de impressão e fale directamente com a nossa equipa.</p><a className="package-btn" href={storage + "pacote-impressao.pdf"} target="_blank" rel="noreferrer">Ver pacote de impressão <span>PDF</span></a></div><div className="price-images"><div className="price-image-wrap"><img src={storage + "pacote-impressao-a5.jpg"} alt="Tabela actualizada do pacote de impressão em formato A5" loading="lazy" decoding="async" /></div><div className="price-image-wrap"><img src={storage + "pacote-impressao-16x24.jpg"} alt="Tabela actualizada do pacote de impressão em formato 16 por 24 centímetros" loading="lazy" decoding="async" /></div></div></div></div></section>
...
{selectedProject && <div className="project-lightbox" role="dialog" aria-modal="true" aria-label="Projecto ampliado" onClick={() => setSelectedProject(null)}><button className="lightbox-close" onClick={() => setSelectedProject(null)} aria-label="Fechar">×</button><img src={selectedProject} alt="Projecto realizado Criartes" onClick={(event) => event.stopPropagation()} /></div>}
      ...
      {podcastNotice && <button className="podcast-notice" type="button" onClick={() => setPodcastOpen(true)}><img src={storage + "podcast-notice.webp"} alt="Podcast Criartes" decoding="async" /><span><small>Brevemente</small>Ver podcast</span></button>}
      {podcastOpen && <div className="podcast-modal" role="dialog" aria-modal="true" aria-label="Podcast Criartes" onClick={() => setPodcastOpen(false)}><div className="podcast-panel" onClick={(event) => event.stopPropagation()}><button type="button" className="podcast-close" aria-label="Fechar" onClick={() => setPodcastOpen(false)}>×</button><div className="podcast-visuals"><div><img className="podcast-logo" src={storage + "podcast-logo.jpg"} alt="Podcast Criartes — Contar a sua história" /></div><div><img className="podcast-host" src={storage + "jose-caculo.jpg"} alt="José Caculo" /><small>Apresentação: José Caculo</small></div></div><div className="podcast-content"><div className="section-kicker">Podcast Criartes</div><h2>Contar a tua história<br /><span>pode inspirar Angola.</span></h2><p className="podcast-lead">POD'S <strong>CONTAR A TUA HISTÓRIA, AQUI!</strong></p><p>Tens uma história de vida única, superação, talento ou uma trajetória que pode inspirar Angola e o mundo? A Criartes vai dar voz à tua vivência, de forma totalmente gratuita.</p><p>Os vencedores ganham a produção completa do seu livro e exemplares de oferta.</p><div className="podcast-columns"><div><strong>Quem pode participar?</strong><p>Cantores e artistas · Escritores e autores · Jogadores e desportistas · Pastores e líderes · Qualquer pessoa com uma vivência transformadora.</p></div><div><strong>Como participar?</strong><p>Escreve a tua história resumidamente ou grava um vídeo curto e envia directamente pelo WhatsApp.</p></div></div><a className="primary-btn" href="https://wa.me/244948595707?text=Olá%20Criartes,%20quero%20contar%20a%20minha%20história%20no%20podcast." target="_blank" rel="noreferrer">Enviar a minha história</a></div></div></div>}
