...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f7f4ef] text-[#191919]">
      ...
      <section id="precos" className="price-highlight"><div className="container"><div className="price-card"><div className="price-copy"><div className="section-kicker light">Oferta em destaque</div><h2>Impressão de livros<br /><em>a partir de 3.500 Kz.</em></h2><p>Escolha o papel ideal para a sua obra: Offset económico ou Pólen premium. Consulte a tabela completa e fale directamente com a nossa equipa.</p><a className="package-btn" href={storage + "pacote-impressao.pdf"} target="_blank" rel="noreferrer">Ver pacote de impressão <span>PDF</span></a></div><div className="price-image-wrap"><img src={storage + "pacote-impressao-preview.webp"} alt="Pacote de impressão da Criartes" loading="lazy" decoding="async" /></div></div></div></section>
